"""Base pipeline step class for the Volnix framework.

Provides a concrete ABC that implements the :class:`~volnix.core.protocols.PipelineStep`
protocol, adding timing helpers and a convenience method for constructing
:class:`~volnix.core.context.StepResult` instances.
"""
