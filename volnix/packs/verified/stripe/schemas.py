...
from volnix.packs.verified.stripe.state_machines import (
    DISPUTE_STATES,
    INVOICE_STATES,
...
PAYMENT_INTENT_ENTITY_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "customer": {"type": "string", "x-volnix-ref": "customer"},
...
REFUND_ENTITY_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "amount": {"type": "integer"},
        "charge": {"type": "string", "x-volnix-ref": "charge"},
        "currency": {"type": "string"},
        "status": {
            "type": "string",
            "enum": REFUND_STATES,
        ...
        "reason": {
            "type": ["string", "null"],
            "enum": ["duplicate", "fraudulent", "requested_by_customer", None],
        },
