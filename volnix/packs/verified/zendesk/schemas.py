...
TICKET_ENTITY_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "assignee_id": {"type": "string", "x-volnix-ref": "user"},
        "requester_id": {"type": "string", "x-volnix-ref": "user"},
        "group_id": {"type": "string", "x-volnix-ref": "group"},
        "organization_id": {"type": "string", "x-volnix-ref": "organization"},
        ...
        "problem_id": {"type": "string", "x-volnix-ref": "ticket"},
...
COMMENT_ENTITY_SCHEMA: dict = {
    ...
    "properties": {
        "id": {"type": "string"},
        "ticket_id": {"type": "string", "x-volnix-ref": "ticket"},
