...
from volnix.actors.state import ScheduledAction, Subscription
...
SUBSCRIPTION_GENERATION = PromptTemplate(
    system="""You are Volnix's subscription generator. Given an actor's role,
...
PERIODIC_CHECK_GENERATION = PromptTemplate(
    system="""You are Volnix's periodic action scheduler. Given an actor's role
