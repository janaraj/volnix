"""CrewAI adapter — convert Volnix tools to CrewAI BaseTool subclasses.
...
def _make_tool_class(
    ...
    class VolnixTool(CrewAIBaseTool):
...
async def crewai_tools(
    ...
    """Load Volnix tools as CrewAI-compatible tool objects.
...
async def crewai_register_agent(
    ...
    """Register an agent with Volnix and get identity-bound tools.
