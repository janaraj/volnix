...
TWEET_ENTITY_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "reply_to_tweet_id": {"type": ["string", "null"], "x-terrarium-ref": "tweet"},
        "retweet_of_id": {"type": ["string", "null"], "x-terrarium-ref": "tweet"},
        "quote_of_id": {"type": ["string", "null"], "x-terrarium-ref": "tweet"},
