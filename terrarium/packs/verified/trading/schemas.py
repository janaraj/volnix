...
ORDER_ENTITY_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "asset_id": {"type": "string", "x-terrarium-ref": "alpaca_asset"},
        "symbol": {"type": "string"},
        "qty": {"type": "number"},
...
NEWS_ENTITY_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "factual_accuracy": {"type": "number", "x-terrarium-internal": True},
        "sentiment_bias": {"type": "number", "x-terrarium-internal": True},
        "market_impact_expected": {"type": "number", "x-terrarium-internal": True},
    },
}
...
ACTIVITY_ENTITY_SCHEMA: dict = {
    ...
    "properties": {
        ...
        "order_id": {"type": "string", "x-terrarium-ref": "alpaca_order"},
        "cum_qty": {"type": "number"},
...
TRADING_TOOL_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "http_path": "/terrarium/social/sentiment",
        "http_method": "GET",
        "parameters": {
            "type": "object",
            "required": ["symbol"],
    ...
    },
    {
        ...
        "http_path": "/terrarium/social/trending",
        "http_method": "GET",
        "parameters": {
            "type": "object",
            "required": [],
    ...
    # ── Animator/System: Market Evolution ──────────────────────
    {
        ...
        "http_path": "/terrarium/market/quote",
        "http_method": "PUT",
        "parameters": {
            "type": "object",
    ...
    },
    {
        ...
        "http_path": "/terrarium/market/bar",
        "http_method": "POST",
        "parameters": {
            "type": "object",
