...
These Pydantic models map to the ``reality:`` section of the Terrarium
...
from terrarium.reality.seeds import Seed as SeedConfig  # noqa: F401 — re-export for back-compat
